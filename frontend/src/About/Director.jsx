  ...
  return (
    ...
    <div className='mt-5 bg-black' >
       <div className='w-full flex flex-col  '>
        <div className='w-full h-16 items-center text-center' style={{backgroundColor:"#84A7BA"}}>
           <h1 className='  font-grotesk text-4xl font-extrabold'> Prof. Dr. Usha Natesan, Director</h1>
        </div>
        <div className='w-full flex flex-row p-5 gap-2 items-center text-center bg-[#BFCBCE]'>
        <img src='/images/dir_un5.jpg' className='w-1/4 h-64 rounded-lg' alt='Description'/>
        <h3 className='text-[#303655]'>
